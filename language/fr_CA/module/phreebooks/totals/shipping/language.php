<?php
/*
 * Langue de traduction pour l'extension phreebooks - totals shipping
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /locale/fr_CA/module/phreebooks/totals/shipping/language.php
 */

$lang     = [
    'title'      => 'Expédition (Par commande)',
    'label'      => 'Expédition',
    'description'=> 'Cette méthode ajoute les frais d&rsquo;expédition pour la commande. Le total cumulé sera utilisé pour calculer les frais d&rsquo;expédition. Il est utilisé pour les opérations de commande, c&rsquo;est-à-dire ventes aux clients et achats aux fournisseurs.',
    'third_party' => 'Tierce parti',
    ];
