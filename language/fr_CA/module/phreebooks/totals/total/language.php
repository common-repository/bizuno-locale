<?php
/*
 * Langue de traduction pour l'extension phreebooks - totals total
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /locale/fr_CA/module/phreebooks/totals/total/language.php
 */

$lang = [
    'title'      => 'Total',
    'description'=> 'Cette méthode calcule le total pour l&rsquo;entrée de journal. Il est utilisé pour les opérations de commande, c&rsquo;est-à-dire ventes aux clients et achats aux fournisseurs. L&rsquo;ordre est fixé à 100 et doit rester la dernière méthode totale (position la plus élevée de l&rsquo;ordre).'];
