<?php
/*
 * Langue de traduction pour l'extension paiement - Méthode Débit Direct (Prélèvement automatique)
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /locale/fr_CA/module/payment/methods/directdebit/language.php
 */

$lang = [
    'title'      => 'Prélèvement automatique',
    'description'=> 'Paiements (EFT), Prélèvement automatique et transfert de Fonds électronique.',
    'check_number' => 'Numéro de réference'];
