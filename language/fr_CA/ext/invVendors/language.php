<?php
/*
 * Langue de traduction pour l'extension Fournisseurs de l'inventaire
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /lib/locale/fr_CA/ext/invVendors/language.php
 */

$lang = [
    'title' => 'Fournisseurs de l&rsquo;inventaire',
    'description' => 'Le module Fournisseurs de l&rsquo;inventaire permet for multiple vendors to be assigend to a single inventory item.',
    'qty_package' => 'Qté par pqt'];
