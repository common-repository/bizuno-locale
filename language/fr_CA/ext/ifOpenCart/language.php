<?php
/*
 * Langue de traduction pour l'extension Interface OpenCart
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /lib/locale/fr_CA/ext/ifOpenCart/language.php
 */

$lang = [
    'title'=> 'Interface OpenCart',
    'acronym' => 'OpenCart',
    'description' => 'Ce module fournit une interface vers la boutique OpenCart. Les fonctionnalités incluent le téléversement/sync des produits, téléchargement de commande/mises à jour d&rsquo;état et plus.',
    ];
