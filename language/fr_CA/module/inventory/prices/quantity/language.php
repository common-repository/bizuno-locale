<?php
/*
 * Langue de traduction pour l'extension inventaire - prix basé sur la quantité
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /locale/fr_CA/module/inventory/prices/quantity/language.php
 */

$lang = [
    'title'      => 'Établissement des prix au niveau de quantité',
    'description'=> 'Établissement du prix basé sur la quantité achetée.'];
