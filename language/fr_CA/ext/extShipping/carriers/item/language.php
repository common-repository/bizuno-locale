<?php
/*
 * Langue de traduction pour l'extension expédition - livraison par article
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /lib/locale/fr_CA/ext/extShipping/carriers/item/language.php
 */

$lang = [
    'title'      => 'Livraison par article',
    'acronym'    => 'Article',
    'description'=> 'Par expédition d&rsquo;article. Définir un seul prix forfaitaire d&rsquo;expédition pour chaque paquet d&rsquo;une commande.',
    'rate'       => 'Le coût de livraison par colis à utiliser pour toutes les commandes utilisant cette méthode d&rsquo;expédition.',
    'GND'        => 'Meilleur moyen',
   ];
