<?php
/*
 * Langue de traduction pour l'extension phreebooks - totals subtotal
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /locale/fr_CA/module/phreebooks/totals/subtotal/language.php
 */

$lang     = [
    'title'      => 'Sous-total de la commande',
    'description'=> 'Cette méthode calcule le total de toutes les lignes d&rsquo;articles de la commande, peu importe l&rsquo;ordre de tri. Cette option est utilisée pour les opérations de commande, c&rsquo;est-à-dire ventes aux clients et achats aux fournisseurs, l&rsquo;ordre est fixé à zéro.'];
