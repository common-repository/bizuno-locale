<?php
/*
 * Include file to generate Code 128 barcodes as modified from fpdf.org
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /apps/FPDF/barcodes/C128.php
 */
...
protected $JSwap  = ["A"=>101, "B"=>100, "C"=>99];   // Caractères de changement de jeu
    ...
    function Barcode(&$PDF, $code, $x, $y, $w=40, $h=15) // Code128($x, $y, $code, $w, $h)
    {
