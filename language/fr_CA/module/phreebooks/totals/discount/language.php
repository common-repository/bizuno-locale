<?php
/*
 * Langue de traduction pour l'extension phreebooks - totals discount
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /locale/fr_CA/module/phreebooks/totals/discount/language.php
 */

$lang     = [
    'title'      => 'Réduction (Par ordre)',
    'label'      => 'Réduction',
    'description'=> 'Cette méthode prend une réduction sur le total cumulé de la commande. Généralement utilisé pour les transactions de commandes, les ventes aux clients et achats aux fournisseurs.'];
