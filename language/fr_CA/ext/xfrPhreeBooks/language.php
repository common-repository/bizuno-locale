<?php
/*
 * Langue de traduction pour l'extension Conversion PhreeBooks
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /lib/locale/fr_CA/ext/xfrPhreeBooks/language.php
 */

$lang = [
    'title' => 'Conversion PhreeBooks',
    'description' => 'Ce module importe une base de données PhreeBooks et les fichiers dans le format Bizuno.'];
