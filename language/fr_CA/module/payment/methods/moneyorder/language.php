<?php
/*
 * Langue de traduction pour l'extension de paiement - M�thode Mandat postal
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /locale/&rsquo;/module/payment/methods/moneyorder/language.php
 */

$lang     = [
    'title' => 'Chèque/Mandat postal',
    'description' => 'Les paiements par chèque bancaire, mandat postal et d&rsquo;autres formes de paiement directes ne nécessitant pas une passerelle de paiement.',
    'check_number' => 'Numéro du chèque'];
