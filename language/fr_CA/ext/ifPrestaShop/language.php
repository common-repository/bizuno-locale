<?php
/*
 * Langue de traduction pour l'extension Interface PrestaShop
 *
 * NOTICE OF LICENSE
 ...
 * @filesource /lib/locale/fr_CA/ext/ifPrestaShop/language.php
 */

$lang = [
    'title'=> 'Interface PrestaShop',
    'acronym' => 'PrestaShop',
    'description' => 'Ce module fournit une interface vers la boutique PrestaShop. Les fonctionnalités incluent le téléversement/sync des produits, téléchargement de commande/mises à jour d&rsquo;état et plus.',
   ];
